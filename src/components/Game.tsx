			...
			{isModalOpen && (
				...
				>
					...
					>
						...
						<button className="group relative h-12 w-[278px] overflow-hidden rounded-md bg-smrtBlue text-lg font-bold text-white justify-end text-center mx-auto inline-block">
							Начать
							<div className="absolute inset-0 h-full w-full scale-0 rounded-md transition-all duration-300 group-hover:scale-100 group-hover:bg-white/30"></div>
						</button>
					</div>
